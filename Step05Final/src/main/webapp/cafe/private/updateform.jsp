	...
	<div class="container">
		...
		<form action="update.jsp?num=<%=num%>" method="post">
			...
			<div class="mb-2">
				...
				<textarea name="content" class="form-control" id="content" rows="10"><%=dto.getContent()%></textarea>
			</div>
			<button type="submit" class="btn btn-primary" onclick="submitContents(this)">저장</button>
		</form>
	</div>
	<%--
